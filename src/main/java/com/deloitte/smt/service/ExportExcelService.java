...
public class ExportExcelService {
	...
	private void createCellRangeAddress(Sheet sheet,HSSFWorkbook workbook) {
		...
		CellRangeAddress cellRangeAddress10 = new CellRangeAddress(0, 0, 10, 20);
		...
		CellRangeAddress cellRangeAddress14 = new CellRangeAddress(1,1,13,15);
		sheet.addMergedRegion(cellRangeAddress14);
		cellRangeAdressList.add(cellRangeAddress14);
		
		CellRangeAddress cellRangeAddress17 = new CellRangeAddress(1,1,16,18);
