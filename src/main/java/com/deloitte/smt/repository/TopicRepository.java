...
public interface TopicRepository extends JpaRepository<Topic, Long> {
    ...
    @Query(value = "SELECT DISTINCT (o.name) FROM Topic o, TopicSignalValidationAssignmentAssignees ta WHERE ta.topicId=o.id AND ta.userGroupKey =:userGroupKey AND o.owner=:owner AND o.name IS NOT NULL ")
    List<String> findDistinctSignalName(@Param("owner")String owner,@Param("userGroupKey")Long userGroupKey);
